...
<div class="filter-menu-bar" style="display: flex; flex-direction: column; align-items: center; gap: 25px; margin-bottom: 40px;">
    ...
    <div style="display: flex; gap: 12px; flex-wrap: wrap; justify-content: center;">
        <?php $categories = ['All', 'Tops', 'Bottoms', 'Hoodies', 'Shoes', 'Outerwear', 'Dresses']; ?>
...
<div class="modern-storefront-grid">
    ...
    try {
        ...
        if ($count > 0) {
            ...
            echo "<p style='text-align: center; width: 100%; color: #94a3b8; padding: 40px 0;'>No items match your filters.<br><small>Try selecting a different category or price range.</small></p>";
        }
    } catch (Exception $e) {
